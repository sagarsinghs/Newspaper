...
public class CheckingAdapter extends RecyclerView.Adapter<CheckingAdapter.ViewHolder> {
    ...
    private List<CheckingObject> mApps;
    private boolean mHorizontal;
    private boolean mPager;

    public CheckingAdapter(boolean horizontal, boolean pager, List<CheckingObject> apps) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (mPager) {
            ...
            return mHorizontal ? new ViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.checking_fragments_adapter, parent, false)) :
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        CheckingObject app = mApps.get(position);
