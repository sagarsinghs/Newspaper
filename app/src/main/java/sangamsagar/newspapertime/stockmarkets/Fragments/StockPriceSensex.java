...
public class StockPriceSensex extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        public  void  setting_the_urls(View view) {
            ...
            arrow_green =(ImageView) view.findViewById(R.id.arrow_green);
            arrow_red = (ImageView) view.findViewById(R.id.arrow_red);
            ...
            trend =(TextView) view.findViewById(R.id.trend);

            URL_FOR_REGISTRATION = "http://appfeeds.moneycontrol.com/jsonapi/market/indices&ind_id=4";
            URL_FOR_REGISTRATION_ADAPTER="https://appfeeds.moneycontrol.com/jsonapi/market/marketmap&format=&type=0&ind_id=4";
                    ...
                    try {
                        ...
                        trend.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                startActivity(new Intent(getActivity(),NewActivityCreatedTesting.class));
                               /* Toast.makeText(getContext(),"Clickng this part",Toast.LENGTH_SHORT).show();
                                Fragment fragment = new StockGraphsRealtime();
                        ...
                        if(Double.parseDouble(change1)>0)
                            arrow_green.setVisibility(View.VISIBLE);
                        else
                            arrow_red.setVisibility(View.VISIBLE);
                        ...
                        open.setText(open1);
                        weekhigh.setText(yearlyhigh1);
                        weeklow.setText(yearlylow1);
